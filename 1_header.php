<nav class="navbar navbar-expand-lg">
  <button class="navbar-toggler mob-sqare-btn" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    &#9776;
  </button>
      <div class="header-logo mob-sqare-btn d-md-block d-lg-none">
    </div>
  <div class="mob-menu">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-3 col-md-4">
        <div class="header-logo mob-sqare-btn">
        </div>
      </div>
      <!-- /.col-4 -->
