  <section id="lease" class="lease">
    <div class="container">
      <h2 class="section-title">Аренда</h2>
      <span class="section-subtitle">Мы предлагаем Вам выгодно взять в аренду текстиль, для банкетов и мероприятий. Наш большой ассортимент гарантирует Вам возможность выбора, а собственный склад и производство - аренду по минимальным ценам и доставку в кратчайшие сроки!
</span>
        ...
        <div class="lease-block  wow fadeInUp" data-wow-delay="0.1s">
          ...
          <!-- /.lease-block__title -->
          <div class="lease-block__text">Вам не нужно самим чистить и гладить текстиль - мы все делаем за Вас!</div>
          <!-- /.lease-block__text -->
        </div>
        <!-- /.lease-block -->
        </div>
