      ...
      <div class="modal-body dark-bg">
        <div class="modal-form">
          <form action="PHPmailer/mailer/smart.php" method="POST" class="main-form">
            ...
            <input type="tel" id="phone-modal" class="modal-form__input" name="user_phone_header" required placeholder="+7 (ХХХ) ХХХ-ХХ-ХХ">
            <div class="modal-form__note">* Мы никогда не передаем Ваши данные третьим лицам.</div>
            <button class="button modal-form__btn" type="submit" data-toggle="modal" data-target="#Modal-1">Оставить заявку!</button>
          </form>
        </div>
      </div>
    </div>
